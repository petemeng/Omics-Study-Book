...
这篇 <em>Cell</em> 论文先用官方图阅读，不直接复制图片。建议打开 <a href="https://www.cell.com/cell/fulltext/S0092-8674(15)00549-8">原文页面</a> 中的 Figure 1、Figure 2 和 Figure 4。读图顺序是：先看 Figure 1 的液滴、bead barcode 和 UMI 如何定义观测单位；再看人鼠混合细胞系如何验证 doublet/barcode 分配；最后看视网膜细胞类型图如何从技术验证走向生物学发现。
</div>
