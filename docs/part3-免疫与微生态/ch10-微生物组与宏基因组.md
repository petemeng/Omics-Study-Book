...
**结果解决了什么生物学问题。** 它们证明 Arabidopsis 根不是被动浸泡在土壤菌库里，而是从土壤中选择性装配 root-associated microbiota。根内群落比土壤群落更收敛，说明植物组织区室施加强过滤；不同 accessions 又能造成细微但可检测的宿主遗传效应。这为后来的 synthetic community、免疫突变体、营养互作和病害抑制研究奠定了设计逻辑。
