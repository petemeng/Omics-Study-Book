...
<div class="biology-primer-title">零基础生物学底座：为什么免疫细胞要有不同受体？</div>
<p>免疫系统需要识别几乎无限多的病原、抗原和异常细胞，但基因组不能为每一种抗原预先写好一个完整受体。B 细胞和 T 细胞的办法是把 V、D、J 等基因片段重新组合，再在连接处加入随机变化，生成大量不同的 BCR 或 TCR。</p>
<p>每个淋巴细胞克隆带着一种受体。遇到合适抗原后，这个克隆会扩增，留下“这次免疫反应选择了谁”的痕迹。B 细胞还会在生发中心继续突变和筛选，产生亲和力更高的抗体。免疫组库测序看的就是这些受体序列，因此它像一本免疫历史账本，而不是普通表达矩阵。</p>
</div>
