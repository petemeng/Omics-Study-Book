...
**结果解决了什么生物学问题。** 这类数据让“甲基化抑制转座子”从概念变成可定位证据：哪些转座子或重复序列甲基化，哪类 context 占主导，是否伴随 small RNA，附近基因表达是否受影响。2009 年人类研究进一步说明细胞状态转换会重塑 methylome，并发现 ESC 中非 CpG methylation 的特殊性。
