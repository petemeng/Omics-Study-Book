...
<figure class="source-figure" markdown="1">
  <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Pre-mRNA.svg" alt="Pre-mRNA processing into mature mRNA with splicing, 5 prime cap, and poly(A) tail">
  <figcaption><strong>图 4.1 · pre-mRNA 到成熟 mRNA。</strong> 这张图把 intron removal、5' cap 和 poly(A) tail 放在同一张分子示意里，适合提醒读者：RNA-seq 的 reads 来自 RNA 生命周期的一个结果层，而不是单纯的“转录强度”。来源：Nastypatty / Manudouz, <a href="https://commons.wikimedia.org/wiki/File:Pre-mRNA.svg">Wikimedia Commons</a>, CC BY-SA 4.0。</figcaption>
</figure>
