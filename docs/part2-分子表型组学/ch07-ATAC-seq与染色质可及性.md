...
<figure class="source-figure" markdown="1">
  <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Nucleosome_structure_and_subunits.svg" alt="Nucleosome structure with histone octamer and DNA wrapped around it">
  <figcaption><strong>图 7.1 · nucleosome structure。</strong> ATAC-seq 的生物学前提是 DNA 被核小体和调控蛋白组织起来；Tn5 更容易进入 nucleosome-depleted 或开放区域。因此先看核小体结构，再理解 fragment length pattern 和 TSS enrichment，会比直接背 QC 指标更稳。来源：Richard Wheeler / Zephyris, <a href="https://commons.wikimedia.org/wiki/File:Nucleosome_structure_and_subunits.svg">Wikimedia Commons</a>, CC BY-SA 3.0。</figcaption>
</figure>
